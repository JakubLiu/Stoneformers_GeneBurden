...
print(output_matrix)
write.table(output_matrix, file = "/data/cephfs-1/work/projects/stoneformers-geneburden/stoneformers/STEP_AFTER_MEETING/SKAT/SKAT_umap_output_matrix.txt", row.names = FALSE, col.names = FALSE)
print('all done')
