...
genotype_matrix <- read.big.matrix(
  ...
  sep = ",",
  header = FALSE,
  backingfile = "genotype_small_backing.bin", # this writes a backup file to disc, chunks will be read into main memory from this binary file
  descriptorfile = "genotype_small_desc.desc", # a metadata file will also be written to disc
  type = "integer"
)
